...
public class Restaurants implements Parcelable{
    ...
    public Restaurants(int restaurantID, String budget, String restaurantName, String restaurantEmail, String restaurantAddress, String restaurantPassword, String restaurantTimmings, String restaurantDishTableName, String posterLink, String speciality, String deliveryDetails, String offer, String rating, int numOfRatings, int pinCode, ArrayList<String> dishTypes) {
